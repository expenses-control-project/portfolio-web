  ...
  return (
    <section id="team-section" className=" py-32 mx-auto max-w-7xl px-6 lg:px-8 w-100 z-10 relative">
      <div className="mx-auto mb-5 max-w-2xl lg:mx-0">
        ...
        <p className="text-gray-400">Un grupo dedicado de colaboradores que trabajan juntos para construir y mantener este proyecto de código abierto. Conoce a las personas que están detrás del código.</p>
        <div className=" flex flex-row sm:justify-between justify-center gap-5 flex-wrap mt-5 items-center">
          <article className="max-w-sm flex flex-col items-center sm:items-start">
            <img
              className="border bg-slate-900 rounded-full"
              src="https://avatars.githubusercontent.com/u/162456552?v=4"
              alt=""
              width={150}
              height={150}
            />
            <h1 className=" text-gray-50">Leonardo La Rosa</h1>
            <h2 className="text-gray-300">Co-Founder / Backend Developer</h2>
          ...
          <article className="max-w-sm flex flex-col items-center sm:items-start">
            <img
              ...
              height={150}
            />
            <h1 className=" text-gray-50">Uciel Daró</h1>
            <h2 className="text-gray-300">Co-Founder / Frontend Developer</h2>
            <div className="mt-2 flex flex-row items-center">
              <a
                target="_blank"
                rel="noopener noreferrer"
